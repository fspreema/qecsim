...
def rotated_surface_code(
    ...
    *,
    ...
    if is_y:
        _add_boundary_labels(distance=distance, qubit_coords=qubit_coords, y_basis=True)
    else:
        _add_boundary_labels(distance=distance, qubit_coords=qubit_coords, y_basis=False)
